...
namespace SimpleMvc.Controllers
{
    public class ProblemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryName,NatureName")] Problem problem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoryName,NatureName")] Problem problem)
        {
            if (id != problem.Id)
            {
                return NotFound();
